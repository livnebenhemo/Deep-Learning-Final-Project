...
def evaluate_weighted_fgm_two_images(self, epsilon, is_defense=False, is_distance=False):
    ...
    for data_batch in tqdm(self.dataloader):
        ...
        with torch.no_grad():
            ...
            perturbed_data1 = weighted_fgm_attack(data1, epsilon, data1_grad)
            perturbed_data2 = weighted_fgm_attack(data2, epsilon, data2_grad)
    ...
    try:
        with open("weighted_fgm_" + str(epsilon) + "_" + experiment_cfg.output.res_txt_fname, 'w') as f:
